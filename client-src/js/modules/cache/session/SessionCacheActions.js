...
module.exports =  {
    ...
    query: function(key) {
        Dispatcher.dispatch({
            actionType: SessionCacheConstants.SESSION_CACHE_QUERY,
			arguments: {
				key: key
			}
        });
	...
	set: function(key, value, ttl) {
		Dispatcher.dispatch({
			actionType: SessionCacheConstants.SESSION_CACHE_SET,
			arguments: {
    ...
    touch: function(key, ttl) {
        Dispatcher.dispatch({
            actionType: SessionCacheConstants.SESSION_CACHE_TOUCH,
            arguments: {
                key: key,
                ttl: ttl
            }
    ...
    remove: function(key) {
        Dispatcher.dispatch({
            actionType: SessionCacheConstants.SESSION_CACHE_REMOVE,
            arguments: {
                key: key
            }
        });
    ...
    purge: function() {
        Dispatcher.dispatch({
            actionType: SessionCacheConstants.SESSION_CACHE_PURGE
        });
    },
    /**
    ...
    publish: function() {
        Dispatcher.dispatch({
            actionType: SessionCacheConstants.SESSION_CACHE_PUBLISH
        });
    },
    /**
    ...
    rollback: function() {
        Dispatcher.dispatch({
            actionType: SessionCacheConstants.SESSION_CACHE_ROLLBACK
        });
    }
};
